...
namespace online_movie
{
    public partial class VisaCard : Form
    {
        ...
        {
            dt.comm.CommandText = "insert into Visa_card values ('" + textBox1.Text + "', '" + comboBox1.Text + "', '" + textBox3.Text + "', '" + textBox4.Text + "', '" + comboBox2.Text + "','" + comboBox3.Text + "','" + comboBox5.Text + "', '" + comboBox4.Text + "', '" + comboBox6.Text + "', '" + textBox2.Text + "')";
            dt.conn.Open();
        ...
        {
            dt.comm.CommandText = "delete from Visa_card where User_Name='" + textBox1.Text + "'";
            dt.conn.Open();
            dt.comm.ExecuteNonQuery();
        ...
        private void button6_Click(object sender, EventArgs e)
        {
            if (textBox1.Text != "")
            {
                ...
                dt.comm.CommandText = "Update Visa_card set User_Name= '" + textBox1.Text + "', Movie_Name= '" + comboBox1.Text + "' , CardHolder_Name= '" + textBox3.Text + "', Card_Number= '" + textBox4.Text + "', Seats= '" + comboBox2.Text + "', Hall= '" + comboBox3.Text + "', Date= '" + comboBox4.Text + "', Showtime= '" + comboBox5.Text + "',Ticket_Number= '" + comboBox6.Text + "' where User_Name='" + textBox1.Text + "'";
        ...
        private void VisaCard_Load(object sender, EventArgs e)
        {
